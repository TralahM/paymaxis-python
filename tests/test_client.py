...
from paymaxis import Paymaxis, AsyncPaymaxis, APIResponseValidationError
...
class TestPaymaxis:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "paymaxis/_legacy_response.py",
                        "paymaxis/_response.py",
    ...
    def test_multipart_repeating_array(self, client: Paymaxis) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: Paymaxis) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Paymaxis) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Paymaxis) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
...
class TestAsyncPaymaxis:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncPaymaxis) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncPaymaxis) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncPaymaxis) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncPaymaxis) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    def test_get_platform(self) -> None:
        ...
        from paymaxis._utils import asyncify
        from paymaxis._base_client import get_platform 
